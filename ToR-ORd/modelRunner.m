...
sexType = 1; if (isfield(parameters,'sexType')) sexType = parameters.sexType; end
...
VCaL_Change = 0;  if (isfield(parameters,'VCaL_Change')) VCaL_Change = parameters.VCaL_Change; end
...
for n=1:beats
    ...
    [time{n}, X{n}]=ode15s(parameters.model,[0 CL],X0,options,1, cellType, sexType, ICaL_Multiplier, ...
    ...
    INaK_Multiplier, INab_Multiplier, ICab_Multiplier, IpCa_Multiplier, ICaCl_Multiplier, IClb_Multiplier, Jrel_Multiplier,Jup_Multiplier,nao,cao,ko,ICaL_fractionSS,INaCa_fractionSS, stimAmp, stimDur, vcParameters, apClamp, extraParams, VCaL_Change);
